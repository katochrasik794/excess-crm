      ...
      <div className="w-full bg-white text-gray-900 flex justify-center px-4 py-6 sm:py-10 lg:px-10 xl:px-16">
        <div className="w-full">
          ...
          <div className="mt-6">
            <button
              type="button"
              className="w-full sm:w-auto md:w-[300px] bg-[#ffde02] hover:bg-yellow-500 text-gray-900 px-8 py-3 rounded-lg text-sm sm:text-base shadow-md transition-colors cursor-pointer"
              onClick={() => {
