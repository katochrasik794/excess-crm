...
const ExnessPrograms = () => {
  ...
  const issueGroups = [
    {
      title: 'Premier',
      options: [
        { id: 'premier-membership', label: 'Membership' },
        { id: 'premier-benefits', label: 'Benefits' },
        { id: 'premier-campaigns', label: 'Campaigns' },
        { id: 'premier-callback', label: 'Callback' },
        { id: 'premier-feedback', label: 'Feedback' },
        { id: 'premier-other', label: 'Other' },
      ]
    },
    {
      title: 'Partnership',
      options: [
        { id: 'partner-general', label: 'General inquiries' },
        { id: 'partner-pa-nav', label: 'Partner personal area navigation' },
        { id: 'partner-commission', label: 'Commission calculation issue' },
        { id: 'partner-rebate', label: 'Rebate issue' },
        { id: 'partner-campaign', label: 'Partner campaign inquiry' },
        { id: 'partner-loyalty', label: 'Loyalty program inquiry' },
        { id: 'partner-feedback', label: 'Partner feedback' },
        { id: 'partner-share-contact', label: 'Share contact details' },
        { id: 'partner-refer-friend', label: 'Refer-a-friend program' },
        { id: 'partner-other', label: 'Other' },
      ]
    },
    {
      title: 'Exness Dollars',
      options: [
        { id: 'exd-calc-help', label: 'I need help with EXD Calculation' },
        { id: 'exd-not-received', label: 'I did not receive EXD' },
        { id: 'exd-cashback-not-received', label: 'I did not receive Cashback' },
        { id: 'exd-spending-help', label: 'I need help with EXD Spending' },
        { id: 'exd-general-help', label: 'I need general help about EXD' },
      ]
    },
    {
      title: 'Digital Affiliates',
      options: [
        { id: 'da-general', label: 'General inquiries' },
        { id: 'da-cpa', label: 'CPA program inquiries' },
        { id: 'da-reward', label: 'Reward inquiries' },
        { id: 'da-pa-nav', label: 'Personal area navigation' },
        { id: 'da-other', label: 'Other' },
      ]
    },
  ];
  ...
  return (
    <>
    <TopContainer />
    <h1 className="text-[32px] font-bold text-[#141d22] mb-2 px-4 md:px-8 lg:px-10 max-w-7xl mx-auto w-full">
