  ...
  const issueGroups = [
    {
      ...
      options: [
        { id: 'change-name', label: 'Change name' },
        { id: 'change-registered-address', label: 'Change registered address' },
      ]
    },
    {
      title: 'Change security type',
      options: [
        { id: 'verification-code-not-received', label: 'Verification code not received' },
        { id: 'no-access-to-security', label: 'No access to current security type' },
      ]
    },
    {
      title: 'Account access issue',
      options: [
        { id: 'payment-method-security', label: 'Payment method security issue' },
        { id: 'personal-area-security', label: 'Personal area/Trading account security issue' },
      ]
    },
    {
      title: 'Regulation & Legal',
      options: [
        { id: 'confirmation-letter', label: 'Confirmation letter request' },
      ]
    },
    {
      title: 'SMS & Emails',
      options: [
        { id: 'sms-code-not-received', label: 'SMS verification code not received' },
        { id: 'email-code-not-received', label: 'Email verification code not received' },
        { id: 'email-not-received', label: 'Email not received' },
      ]
    },
    {
      title: 'More',
      options: [
        { id: 'something-went-wrong', label: '"Something went wrong" issue' },
        { id: 'sign-in-issue', label: 'Sign-in issue' },
        { id: 'brand-violation', label: 'Brand violation' },
