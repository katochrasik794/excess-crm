  ...
  const issueGroups = [
    {
      ...
      options: [
        { id: 'terminal-updates', label: 'Terminal updates' },
        { id: 'high-ping-issue', label: 'High ping issue' },
      ]
    },
    {
      title: 'Access to VPS',
      options: [
        { id: 'password-issue', label: 'Password issue' },
        { id: 'unable-to-login', label: 'Unable to login' },
      ]
    },
    {
      title: 'More',
      options: [
        { id: 'software-language-installation', label: 'Software/language installation' },
